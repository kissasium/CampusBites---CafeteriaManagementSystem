...
namespace WinFormsApp1
{
    public partial class Cafe : Form
    {
        ...
        private void coffee_button10_Click(object sender, EventArgs e)
        {
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 28";
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 28 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Coffee' ";
        ...
        private void greenTea_button5_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 29";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 29 + "','" + 0 + "', '" + 50 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Green Tea' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
                            ...
                            if (reader2.Read())
                            {
                                ...
                                //now add milo to cart
                                SqlCommand sqlcomm2 = new SqlCommand("insert into CartItem " +
                                        "values('" + cartID + "', '" + itemID + "','" + 0 + "', '" + 50 + "')", sqlconn);
        ...
        private void mocha_button11_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 30";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 30 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Iced Mocha' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
        ...
        private void chai_button8_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 3";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 3 + "','" + 0 + "', '" + 70 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Karak Chai' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
                            ...
                            if (reader2.Read())
                            {
                                ...
                                //now add milo to cart
                                SqlCommand sqlcomm2 = new SqlCommand("insert into CartItem " +
                                        "values('" + cartID + "', '" + itemID + "','" + 0 + "', '" + 70 + "')", sqlconn);
