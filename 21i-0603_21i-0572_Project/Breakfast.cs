...
namespace WinFormsApp1
{
    public partial class Breakfast : Form
    {
        ...
        private void waffles_button10_Click(object sender, EventArgs e)
        {
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                  //  MessageBox.Show("Cart already exists");
                    ...
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 16";
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 16 + "','" + 0 + "', '" + 200 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Waffles' ";
        ...
        private void halwapuri_button11_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                   // MessageBox.Show("Cart already exists");
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 17";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 17 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Halwa Puri' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
        ...
        private void paratha_button5_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                   // MessageBox.Show("Cart already exists");
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 18";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 18 + "','" + 0 + "', '" + 110 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Paratha' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
        ...
        private void pancakes_button8_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                  //  MessageBox.Show("Cart already exists");
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 19";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 19 + "','" + 0 + "', '" + 200 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Pancakes' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
