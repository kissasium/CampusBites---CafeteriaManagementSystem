...
namespace WinFormsApp1
{
    public partial class Dessert : Form
    {
        ...
        private void donut_button10_Click(object sender, EventArgs e)
        {
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                   // MessageBox.Show("Cart already exists");
                    ...
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 24";
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 24 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Donut' ";
        ...
        private void brownie_button5_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 25";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 25 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Brownie' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
        ...
        private void cookie_button11_Click(object sender, EventArgs e)
        {
            var connectionString = "Data Source=LAPTOP-S1HUQ0ID\\SQLEXPRESS;Database = CampusBites; Integrated Security=True";
            SqlConnection sqlconn = new SqlConnection(connectionString);
            sqlconn.Open();
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 26";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 26 + "','" + 0 + "', '" + 180 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Cookie' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
        ...
        private void macaron_button8_Click(object sender, EventArgs e)
        {
            ...
            if (reader11.Read())
            {
                ...
                if (reader111.Read())
                {
                   // MessageBox.Show("Cart already exists");
                    ...
                    //if item already exists then go to cart form
                    string q2 = "Select itemID from Cartitem where cartID = '" + existing_cartID + "' and itemID = 27";
                    SqlCommand q2cmd = new SqlCommand(q2, sqlconn);
                    SqlDataReader q2reader = q2cmd.ExecuteReader();
                    ...
                    else    //item does not exist in cart so insert in cartitem
                    {
                        ...
                        //now add coke to cart
                        SqlCommand sqlcomm22 = new SqlCommand("insert into CartItem " +
                                "values('" + existing_cartID + "', '" + 27 + "','" + 0 + "', '" + 200 + "')", sqlconn);
                ...
                else     //cart does not exist 
                {
                    ...
                    else
                    {
                        ...
                        if (reader1.Read())
                        {
                            ...
                            //find ItemID
                            string query2 = "Select itemID from item where itemName = 'Macaron' ";
                            SqlCommand cmd2 = new SqlCommand(query2, sqlconn);
                            SqlDataReader reader2 = cmd2.ExecuteReader();
